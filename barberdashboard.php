						...
						<div class="contact_form"> 
							...
							<table class="table">
								...
								<tr>
									...
									<?php if ($appointment['status'] !== 'Attended' && $appointment['status'] !== 'Cancelled' ) : ?>
    								<th scope="col"><a href="functions.php?appid=<?php echo $appointment['app_id']; ?>" class="btn btn-success">Attend</a></th>
									<th scope="col"><a href="functions.php?appid=<?php echo $appointment['app_id']; ?>&cancel=1" class="btn btn-danger">Cancel</a></th>
									<?php endif; ?>
								</tr>
								<?php } ?>
